            ...
            <div class="row">
                <div class="span5 offset1 well-small" style="text-align: left">
                    ...
                    <c:if test="${ not empty client.logoUri }">
                        <ul class="thumbnails">
                            <li class="span5">
                                <a class="thumbnail" data-toggle="modal" data-target="#logoModal"><img
                                        src="api/clients/${ client.id }/logo"/></a>
                            </li>
                        </ul>
                        <!-- Modal -->
                        <div id="logoModal" class="modal hide fade" tabindex="-1" role="dialog"
                        ...
                        <c:choose>
                            <c:when test="${ empty client.redirectUris }">
                                <div class="alert alert-block alert-error">
                                    ...
                                    <spring:message code="approve.redirect_uri"
                                                    arguments="${ fn:escapeXml(redirect_uri) }"/>
                                </div>
                            </c:when>
                            <c:otherwise>
                                <spring:message code="approve.redirect_uri"
                ...
                <div class="span4">
                    <fieldset style="text-align: left" class="well">
                        ...
                        <c:forEach var="scope" items="${ scopes }">
                            ...
                            <label for="scope_${ fn:escapeXml(scope.value) }" class="checkbox">
                                <input type="checkbox" name="scope_${ fn:escapeXml(scope.value) }"
                    ...
                    <fieldset style="text-align: left" class="well">
                        ...
                        <label for="remember-forever" class="radio">
                            <input type="radio" name="remember" id="remember-forever"
                        ...
                        <label for="remember-not" class="radio">
                            <input type="radio" name="remember" id="remember-not"
                                   value="none" ${ consent ? 'checked="checked"' : '' }>
